...
class TestSyllabusMakerPageWithNewInput(StaticLiveServerTestCase):
    ...
    def test_work(self):
        ...
        self.browser.find_element_by_xpath('/html/body/form/dev[43]/input').click()
        self.browser.find_element_by_xpath('/html/body/form/dev[45]/input').click()
        time.sleep(3)
...
class TestCalendarFunctionality(StaticLiveServerTestCase):
    ...
    def test_work(self):
        ...
        self.browser.find_element_by_xpath('/ html / body / div[1] / div[3] / div[25]').click()
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[2] / input').send_keys('CMSC 421 Hw5 Due & CMSC 411 Exam')
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[2] / button[1]').click()
        time.sleep(5)

        self.browser.find_element_by_xpath('/html/body/div[1]/div[3]/div[29]').click()
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[2] / input').send_keys('CMSC 447 Hw5 Due')
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[2] / button[1]').click()
        time.sleep(5)

        self.browser.find_element_by_xpath('/html/body/div[1]/div[3]/div[30]').click()
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[2] / input').send_keys('CMSC 426 Hw7 Due')
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[2] / button[1]').click()
        time.sleep(5)
        ...
        self.browser.find_element_by_xpath('/html/body/div[1]/div[3]/div[30]').click()
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[3] / input').send_keys(' & CMSC 447 Exam')
        time.sleep(3)
        self.browser.find_element_by_xpath('/ html / body / div[3] / button[1]').click()
        time.sleep(3)

        self.browser.find_element_by_xpath('/ html / body / div[1] / div[1] / div[3] / button').click()
        time.sleep(3)
