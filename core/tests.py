...
from core.forms import SyllabusCreateForm
...
class TestSyllabusMakerPage(StaticLiveServerTestCase):
    ...
    def test_work(self):
        ...
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[8]/input').send_keys(
            'randomemail@umbc.edu')
        ...
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[16]/input').send_keys(
            'Joseph Young,Zoe Morgan,Jennifer Gill')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[18]/input').send_keys(
            'jyoung2@umbc.edu,mjenn10@umbc.edu,jgill2@umbc.edu')
        ...
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[24]/input').send_keys(
            'Natural Selection,Genetics,Speciation,Phylogeny')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[26]/input').send_keys(
            'Biological Science 4th edition (volume 2), Scott Freeman, Prentice Hall Publishers')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[28]/input').send_keys(
            'The goal of this course is to present an important series of topics in organismal biology ')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[30]/input').send_keys(
            'Must complete MATH 150 or MATH 155 or MATH 151 with a C grade or better')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[32]/input').send_keys(
            'Homework,Exam,Quiz')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[34]/input').send_keys('10%,60%,30%')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[36]/input').send_keys(
            'Read chapter 1,Read chapter 2,Read chapter 3,Read chapter 4')
        self.browser.find_element_by_xpath('/html/body/center/div[2]/form/dev[38]/input').send_keys(
            '07/16,07/22,07/26,07/28')
        time.sleep(3)
...
class TestCalendarFunctionality(StaticLiveServerTestCase):
    ...
    def test_work(self):
        ...
        time.sleep(3)
        self.browser.find_element_by_xpath('/html/body/div[2]/div[2]/input').send_keys(
            'CMSC 421 Hw5 Due & CMSC 411 Exam')
        time.sleep(3)
...
class CreateSyllabusFormTests(TestCase):
    ...
    def test_syllabus_create_form(self):
        form_data = {'course_name':             'Test Course Name',
                     ...
                     'instructor_email':        'testy@testmail.com',
